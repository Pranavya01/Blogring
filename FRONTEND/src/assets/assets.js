...
import blogApp_logo from "./blogApp_logo.png";
import blogApp_logo_1 from "./blogApp_logo_1.png";
import writing_blogs from "./writing_blogs.png";
import reading_blogs from "./reading_blogs.png";
import comments_blogs from "./comments_blogs.png";
import blogging_platform_image from "./blogging_platform_image.png";
...
import secret_blog from "./secret_blog.png";
import travel_blog from "./travel_blog.png";
import food_blog from "./food_blog.png";
import author_one from "./author_one.png";
import author_two from "./author_two.png";
import author_three from "./author_three.png";
import author_four from "./author_four.png";
import author_five from "./author_five.png";
import author_six from "./author_six.png";
import parenting_photo from "./parenting_photo.jpeg";
import fitness_photo from "./fitness_photo.jpeg";
import buisness_photo from "./buisness_photo.jpeg";
import login_page from "./login_page.webp";
import blog_post from "./blog_post.webp";
import comments_post from "./comments_post.webp";
import drafts_post from "./drafts_post.jpeg";
import community_photo from "./community_photo.jpg";
import empowerment_photo from "./empowerment_photo.jpg";
import excellence_photo from "./excellence_photo.webp";
import innovation_photo from "./innovation_photo.jpg";
import integrity_photo from "./integrity_photo.jpg";
import collaboration_photo from "./collaboration_photo.jpg";
import write_blog from "./write_blog.png";
import contact_us from "./contact_us.webp";
import register_user from "./register_user.avif";
import optimized_content from "./optimized_content.png";
import customizable_template from "./customizable_template.png";
import depth_analysis from "./depth_analysis.png";
import global_reach from "./global_reach.png";
import community_engage from "./community_engage.png";
import improvised_writing from "./improvised_writing.png";
import feature_page from "./feature_page.webp";
...
export const author_data = [
  ...
  {
    _id: "9ud63bha51mgjut85d21m9yds",
    title: "Liam Morgan",
    subTitle: "Adventure-scarred veteran transforming survival into stories of grit and grace.",
    description: "Liam Morgan is a seasoned storyteller whose real-life adventures echo the pulse-pounding action of his novels. A former Naval Service corpsman turned special warfare operator, Liam has trained in some of the world’s harshest environments—from Arctic tundras to dense West African jungles. His firsthand experience in parachuting, combat diving, and reconnaissance missions infuses his writing with gritty realism and heart-pounding authenticity. When he’s not crafting tales of survival and redemption like Flight of the Wild Geese, Liam can be found exploring the outdoors, competing in triathlons, or diving into history’s lesser-known corners. His stories are a tribute to resilience, courage, and the enduring human spirit.",
    image: author_one,
    email: "liam_morgan2302@gmail.com",
    linkedIn: "linkedIn.com/in/liammorgan",
    website: "www.liamMorgan.com",
  },

  {
    _id: "dj73ba61mkf41fdremoy74bch",
    title: "Ethan Clarke",
    subTitle: "Helping lovebirds script their forever-with flair, heart, and a bit of magic",
    description: "Ethan Clarke is a passionate writer and creative mind behind Getting to Yes!, a heartfelt guide to crafting the perfect marriage proposal. Inspired by his own unforgettable moment at the foot of the Eiffel Tower, Ethan founded TheMarriageProposal.com in 2012 to help others turn their love stories into lifelong memories. With a flair for romance and a knack for storytelling, Ethan blends practical advice with emotional insight, offering readers a roadmap to one of life’s most meaningful questions. When he’s not writing or brainstorming unique proposal ideas, he enjoys traveling, photography, and celebrating love in all its forms.",
    image: author_two,
    email: "ethan_clarke2153@gmail.com",
    linkedIn: "linkedIn.com/in/ethanclarke",
    website: "www.ethanclarke.com",
  },

  {
    _id: "74uej8391mvy3if83mf92nmg7",
    title: "Jayden Brooks",
    subTitle: "Queer romance, bold voices, and unapologetic joy between the lines.",
    description: "Jayden Brooks is a spirited storyteller with a flair for romance, wit, and heart. Known for her debut Clique and other heartfelt tales, Jayden crafts stories where love always finds a way—often with a dash of sass and a whole lot of charm. Her writing celebrates the beauty of connection, especially in LGBTQ+ narratives that champion authenticity and joy. Living in the suburbs of Chicago with her family, a golden retriever named Mickey, and a cat who simply never left, Jayden finds inspiration in everyday magic. She’s a confessed tea enthusiast, a fan of gingers, and a believer that everyone deserves their happily ever after.",
    image: author_three,
    email: "jayden_brooks8397@gmail.com",
    linkedIn: "linkedIn.com/in/jaydenbrooks",
    website: "www.jaydenbrooks.com",
  },

  {
    _id: "7h53tabc6109tm8643bxg3ks3",
    title: "Sophia Bennett",
    subTitle: "Champion of creativity, from catwalk dreams to palace intrigues.",
    description: "Sophia Bennett is an award-winning British author whose stories celebrate creativity, courage, and the quiet power of self-discovery. From her breakout young adult novel Threads, which won the Times/Chicken House Prize in 2009, to her elegant royal mysteries written as S.J. Bennett, Sophia’s writing spans genres and generations. Her books have been translated into over 20 languages, and her cozy crime series featuring Queen Elizabeth II as a secret sleuth has charmed readers worldwide. With a PhD in Modern Italian Literature and a background that includes everything from management consulting to earring packaging, Sophia brings a rich tapestry of experience to her storytelling.",
    image: author_four,
    email: "sophia_bennett7183@gmail.com",
    linkedIn: "linkedIn.com/in/sophiabennett",
    website: "www.sophiabennett.com",
  },

  {
    _id: "61ydh48mxna42hdy5790ikd12",
    title: "Emily Rhodes",
    subTitle: "Bookwalker, essayist, and quiet revolutionary of the literary kind.",
    description: "Emily Rhodes is a London-based writer, literary journalist, and community builder who believes in the power of books to connect people. She is the founder of Emily’s Walking Book Club, a 3,000-strong group that meets monthly to discuss literature while strolling through Hampstead Heath. Her passion for accessibility and storytelling also led her to create Bookbanks, a charity that brings books to food banks across the UK. Emily’s writing appears in publications like The Guardian, Financial Times Weekend, and The Spectator, where she explores themes of art, architecture, and literature. Whether she’s interviewing authors, hosting literary events, or writing about the books she loves to reread, Emily brings warmth, insight, and a deep appreciation for the written word.",
    image: author_five,
    email: "emily_rhodes0984@gmail.com",
    linkedIn: "linkedIn.com/in/emilyrhodes",
    website: "www.emilyrhodes.com",
  },

  {
    _id: "8udjeu715abcvdref25478owk",
    title: "Oliva Chen",
    subTitle: "Engineering the quantum future—one superconducting breakthrough at a time.",
    description: "Dr. Olivia Chen is a pioneering researcher and author at the intersection of superconducting electronics and ultra-efficient computing. Currently an Associate Professor at Tokyo City University and a PRESTO researcher with Japan Science and Technology Agency, Olivia’s work focuses on deep learning hardware accelerators and design automation for superconducting VLSI systems. With a PhD from Yokohama National University, Olivia has published extensively on adiabatic quantum-flux-parametron circuits and energy-efficient logic design. Her contributions have earned her multiple awards, including the JST FOREST Award and recognition from the Cryogenic Society of America. Olivia’s writing bridges the technical and the visionary, offering a glimpse into the future of computing.",
    image: author_six,
    email: "oliva_chen2302@gmail.com",
    linkedIn: "linkedIn.com/in/olivachen",
    website: "www.olivachen.com",
  }
