  ...
  return (
    <div className="relative px-5 w-screen min-h-screen overflow-hidden bg-gradient-to-r from-gray-600 via-gray-700 to-gray-900">
      <img
        ...
        alt=""
        onClick={() => navigate("/")}
        className="h-24 w-28 absolute top-5 animate-pulse left-5 rounded-lg shadow-xl shadow-orange-700 active:scale-90 duration-200 ease-in-out cursor-pointer"
      />
      <h1 className="text-5xl animate-slideUp bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-yellow-500 to-orange-700 font-extrabold text-center m-6">
        CONTACT US
      </h1>
      <button
        onClick={() => navigate("/")}
      ...
      <div className="animate-slideUp mt-4 relative mx-auto w-screen max-w-screen-lg">
        ...
        />
        <div className="absolute inset-0 flex pt-6 flex-col items-center justify-center gap-3 rounded-lg bg-black/50">
      ...
      <div className="flex flex-col animate-slideUp items-center gap-6 m-6 p-6 bg-gradient-to-r from-blue-400 via-yellow-500 to-orange-700 rounded-xl shadow-xl shadow-orange-800 max-w-5xl mx-auto">
